                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const Text(
                          'سعی کنید کتانی تان را تمیز نگه دارید. اگر سفید است و همیشه تمیز که تبریک می گم شما بسیار منظم و خوش سلیقه هستید، اما زیاد هم سخت نگیرید؛ کمی کثیف بودن کتانی هیچ اشکالی ندارد و می توانید تا وقتی اوضاع خیلی بغرنج نشده خودتان را به سختی نیندازید.',
